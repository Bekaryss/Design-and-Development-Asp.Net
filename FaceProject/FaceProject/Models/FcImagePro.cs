...
namespace FaceProject.Models
{
    ...
    public class FcImagePro
    {
        ...
        /// </summary>
        public Rectangle EyeBetweenRect { get; set; }
        /// <summary>
        ...
        /// </summary>
        public bool BetweenEyeSens { get; set; }
        /// <summary>
        ...
        public FcImagePro(Bitmap _cimg, Rectangle _rect, Rectangle _topRect, Rectangle _leftRect, Rectangle _rightRect, Rectangle _bottomRect, Rectangle _eyeRectLeft, Rectangle _eyeRectRight, Rectangle _eyeRectBetween, Rectangle _mouthRectBottom)
        {
            CurrentImage = _cimg;
            MainRect = _rect;
            TopRect = _topRect;
            ...
            EyeBetweenRect = _eyeRectBetween;
